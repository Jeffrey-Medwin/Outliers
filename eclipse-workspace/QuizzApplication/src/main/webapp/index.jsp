...
<body class="bg-secondary">
	...
	<div class="row ms-3 me-3">
		<img alt="outliers" src="outliers.png" style="width: 100px; height: 80px;" class="col">
	...
	<div class="container-md mt-5 mb-3">
		<form action="Login" method="post" class="row bg-dark p-4">
			<div class="col" style="text-align: center;">
				<img alt="login" src="login.png" width="70px" height="70px">
			</div>
